package com.lawnics.printingpartner.CustomGallery.config;
...
public class ImageConfig implements Serializable {
    ...
    private int toolbarBackgroundColor = R.color.colorPrimary;
    private int toolbarTextColor = R.color.control_background;
